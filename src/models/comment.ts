...
export interface CommentInstance
  ...
  setPost: Sequelize.BelongsToSetAssociationMixin<
    PostInstance,
    PostInstance["id"]
  >;
  createPost: Sequelize.BelongsToCreateAssociationMixin<
    PostAttributes,
    PostInstance
  >;
  ...
  setUpvoters: Sequelize.BelongsToManySetAssociationsMixin<
    UserInstance,
    UserInstance["id"],
    "PostUpvotes"
  >;
  addUpvoters: Sequelize.BelongsToManyAddAssociationsMixin<
    UserInstance,
    UserInstance["id"],
    "PostUpvotes"
  >;
  addUpvoter: Sequelize.BelongsToManyAddAssociationMixin<
    UserInstance,
    UserInstance["id"],
    "PostUpvotes"
  >;
  createUpvoters: Sequelize.BelongsToManyCreateAssociationMixin<
    UserAttributes,
    UserInstance["id"],
    "PostUpvotes"
  >;
  removeUpvoter: Sequelize.BelongsToManyRemoveAssociationMixin<
    UserInstance,
    UserInstance["id"]
  >;
  removeUpvoters: Sequelize.BelongsToManyRemoveAssociationsMixin<
    UserInstance,
    UserInstance["id"]
  >;
  hasUpvoter: Sequelize.BelongsToManyHasAssociationMixin<
    UserInstance,
    UserInstance["id"]
  >;
  hasUpvoters: Sequelize.BelongsToManyHasAssociationsMixin<
    UserInstance,
    UserInstance["id"]
  >;
...
export const CommentFactory = (
  ...
  const Comment = sequelize.define<CommentInstance, CommentAttributes>(
    "Comment",
    attributes
  );
